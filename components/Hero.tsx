...
const Hero = () => {
  return (
    <div className="xl:h-[80vh] w-full pb-20 sm:pb-0 pt-20 mb-20 sm:mb-40 bg-secondary overflow-hidden">
      <div className="flex w-full h-full max-container py-20 px-10">
        <div className="flex-1">
          <h1 className="text-white text-xl xs:text-3xl sm:text-5xl md:text-6xl font-semibold md:leading-[66px] tracking-wide xs:pt-20 lg:pt-28 z-50">
            Savor the Flavors:
